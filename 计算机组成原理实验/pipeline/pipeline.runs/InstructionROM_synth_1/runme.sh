...
HD_PWD='C:/Users/guzy0/pipeline/pipeline.runs/InstructionROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InstructionROM.vds -m64 -mode batch -messageDb vivado.pb -notrace -source InstructionROM.tcl
