...
HD_PWD='C:/Users/guzy0/pipeline/pipeline.runs/DataRAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataRAM.vds -m64 -mode batch -messageDb vivado.pb -notrace -source DataRAM.tcl
