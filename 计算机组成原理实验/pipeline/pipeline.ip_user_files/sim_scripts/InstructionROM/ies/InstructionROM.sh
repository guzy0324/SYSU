...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../../pipeline.srcs/sources_1/ip/InstructionROM/sim/InstructionROM.vhd" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.InstructionROM $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.InstructionROM -input simulate.do
}
# Script usage
usage()
{
