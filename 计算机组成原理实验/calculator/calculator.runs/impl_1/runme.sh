...
HD_PWD='C:/Users/guzy0/calculator/calculator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log display.vdi -applog -m64 -messageDb vivado.pb -mode batch -source display.tcl -notrace
