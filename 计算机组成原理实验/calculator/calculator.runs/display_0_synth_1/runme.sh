...
HD_PWD='C:/Users/guzy0/calculator/calculator.runs/display_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log display_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source display_0.tcl
