...
HD_PWD='G:/project/pri_carry/pri_carry.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log chaoadder.vdi -applog -m64 -messageDb vivado.pb -mode batch -source chaoadder.tcl -notrace
