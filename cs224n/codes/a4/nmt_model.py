...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        init_decoder_hidden = self.h_projection(torch.cat(list(last_hidden), 1))
        init_decoder_cell = self.c_projection(torch.cat(list(last_cell), 1))
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        e_t = self.att_projection(enc_hiddens).bmm(dec_hidden.unsqueeze(2)).squeeze(2)
