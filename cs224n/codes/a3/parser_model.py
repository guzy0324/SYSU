...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        x = self.embeddings[w].reshape(-1, self.n_features * self.embed_size)
    ...
    def forward(self, w):
        ...
        logits = self.dropout(F.relu(self.embedding_lookup(w) @ self.embed_to_hidden_weight + self.embed_to_hidden_bias)) @ self.hidden_to_logits_weight + self.hidden_to_logits_bias
