...
def get_CIFAR10_data(
    ...
    #     if y_train[i] not in x_y_train.keys():
    #         x_y_train[y_train[i]] = [X_train[i]]
    #     else:
    #         x_y_train[y_train[i]].append(X_train[i])
    # x_train = []
    # Y_train = []
    # for i in x_y_train.keys():
    #     x_train.append(random.sample(x_y_train[i], 500))
    #     Y_train.append([i for _ in range(500)])
