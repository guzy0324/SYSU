...
The length of leaf table is equal to the length of string table. And indices of strings in string table are also served as indices of leaf nodes in leaf table.
...
/* maintain_leaf_table finds a leaf node in leaf table.
